 ...
 * @discussion Setting this property registers the class for headers for this collection view. Setting the class when the view is already displayed results in undefined behavior. The default value is returned by `[KTPhotosSectionInfoHeaderView class]`. This value must not be `nil`.
 */
 ...
 * @discussion Setting this property registers the specified reuse identifier for section headers for this collection view. Setting the identifier when the view is already displayed results in undefined behavior. The default value is returned by `[KTPhotosSectionInfoHeaderView headerReuseIdentifier]`. This value must not be `nil`.
 */
