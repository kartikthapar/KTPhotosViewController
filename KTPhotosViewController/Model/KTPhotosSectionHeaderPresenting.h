 ...
 * @discussion The `KTPhotosSectionInfoHeaderView` implements the `KTPhotosSectionHeaderPresenting` to update contents of a header view. You can provide your own header class to present header views and not implement the `KTPhotosSectionHeaderPresenting` protocol. However, if you wish to provide similar content, then subclassing `KTPhotosSectionInfoHeaderView` is the way to go.
 */
